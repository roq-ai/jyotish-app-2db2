...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'astrologer', 'admin'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Chart', path: '/charts', entity: 'chart', service: AccessServiceEnum.PROJECT, icon: FiPieChart },
    { name: 'Customer', path: '/customers', entity: 'customer', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
